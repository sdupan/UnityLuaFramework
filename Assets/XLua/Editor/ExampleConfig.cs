...
public static class ExampleConfig
{
    ...
    static List<string> exclude = new List<string> {
       ...
       "UnityEngine.ParticleSystemForceField", "System.Activator"
    };

    static List<string> projectExclude = new List<string> {
        "Pathfinding.EditorResourceHelper",
        "IdleGame.CSharpCallLuaExport"
    };
    ...
    static bool isProjectExcluded(Type type)
    {
       var fullName = type.FullName;
       for (int i = 0; i < projectExclude.Count; i++)
       {
           if (fullName.Contains(projectExclude[i]))
           {
               return true;
           }
       }
    ...
    public static IEnumerable<Type> LuaCallCSharp
    {
       get
       {
           ...
           var customTypes = (from assembly in customAssemblys.Select(s => Assembly.Load(s))
                              from type in assembly.GetExportedTypes()
                              where type.Namespace == null || !type.Namespace.StartsWith("XLua") && !isProjectExcluded(type)
                                      && type.BaseType != typeof(MulticastDelegate) && !type.IsInterface && !type.IsEnum
                              select type);
    ...
    public static List<List<string>> BlackList = new List<List<string>>()  {
                ...
                new List<string>(){"UnityEngine.CanvasRenderer", "OnRebuildRequested"},
                ...
                new List<string>(){"UnityEngine.Caching", "SetNoBackupFlag", typeof(string).FullName, "UnityEngine.Hash128"},
                new List<string>(){"UnityEngine.Caching", "ResetNoBackupFlag", typeof(string).FullName, "UnityEngine.Hash128"},
                ...
                new List<string>(){"Pathfinding.NodeLink", "LinkObjects", "UnityEngine.Transform", "UnityEngine.Transform", typeof(bool).FullName},
                new List<string>(){"Pathfinding.NodeLink", "LinkObjects"},
                new List<string>(){"Pathfinding.NodeLink", "UnlinkObjects"},
                new List<string>(){"Pathfinding.NodeLink", "DeleteLinks"},
                new List<string>(){"Pathfinding.FunnelModifier", "AddComp", "UnityEditor.MenuCommand"},
                new List<string>(){"Pathfinding.RaycastModifier", "AddComp", "UnityEditor.MenuCommand"},
                new List<string>(){"Pathfinding.SimpleSmoothModifier", "AddComp", "UnityEditor.MenuCommand"},
                new List<string>(){"Pathfinding.AlternativePath", "AddComp", "UnityEditor.MenuCommand"},
            };
