...
function checknumber(value, base,defaultValue)
    defaultValue = defaultValue or 0
    return tonumber(value, base) or defaultValue
end
...
function class(classname, ...)
    ...
    for _, super in ipairs(supers) do
        ...
        if superType == "function" then
            ...
            --print(classname.." -> super type = function")
            cls.__create = super
    ...
    if not cls.__supers or #cls.__supers == 1 then
        ...
        setmetatable(cls, {__index = function(_, key)
            ...
            --dump(supers, classname.." find key = "..key.." in -> ", 60)
            for i = 1, #supers do
                local super = supers[i]
                if super[key] then print(classname.." found key "..key.." in "..tostring(super.__cname)) return super[key] end
            end
        end})
    end
...
function IsEmptyTable(tb)
    ...
    if type(tb) == "table" and next(tb) then
        return false
    end
